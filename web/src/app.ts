...
class Desktop {
    ...
    public constructor(root: HTMLElement) {
        ...
        this.root.style.backgroundImage = `url("/logo.jpeg")`
    }
...
class DropDown {
    ...
    public constructor(args: {
        ...
        this.root.onmouseover = () => {
            ...
            this.itemsDiv.style.display = "initial"
        }
...
window.onload = () => {
    ...
    desktop.toolbar.addToolbarButton(btn)

    const btn2 = new ToolbarButton()
    desktop.toolbar.addToolbarButton(btn2)

    const dropDown = new DropDown({
        items: ["item1", "item2", "item3", "item4", "item5"]
    })
    desktop.toolbar.addToolbarButton(dropDown)
